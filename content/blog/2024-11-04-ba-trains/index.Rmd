...
ggplot(map_data) +
  ...
  # Rail data
  geom_sf(data = rail_map, mapping = aes(color = network),
          linewidth = 2, lineend = "round") +
  scale_color_manual(values = c("Belgrano Sur" = "#fcba03", "Other" = "#575757")) +
  # Subway data
  geom_sf(data = subway_map, color = "#575757", linewidth = 2, lineend = "round") +
  theme_minimal() +
  theme(
